  ...
  return (
    <main id="main-content">
      ...
      <article
        className="methodArticle"
        id="fig5-permutation"
        aria-label="Figure 5e,g permutation analysis"
      >
        <section>
          <p className="sectionLabel">Figure 5e,g · Input data</p>
        ...
        <section>
          <p className="sectionLabel">Figure 5e,g · Statistical analysis</p>
          <h2>Figure 5e,g: paired exact sign-flip permutation tests</h2>
          <p>
            For each mouse, the paired difference was calculated as the
            comparison value minus its Before value and studentized by its
            s.e.m. Under the null hypothesis, the sign of each within-mouse
            difference was exchangeable. With n = 10, all 1,024 possible sign
            assignments were enumerated to obtain exact two-sided P values.
          </p>
          <h3>Comparisons</h3>
          <ol>
        ...
        <section>
          <p className="sectionLabel">Figure 5e,g · Outputs and files</p>
        ...
        <section>
          ...
          <div className="articleLinks">
            <a className="repoLink" href="/python-code#exfig10-mixture">
              Extended Data Fig. 10 mixture-audit code →
            </a>
            <a
              className="repoLink"
